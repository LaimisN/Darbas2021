...
{
    public class PiguCartPage2 : BasePage2

    {
        ...
        public PiguCartPage2(IWebDriver webdriver) : base(webdriver) //konstruktoriumi perduodame driver is base klases
        {
        }
        public PiguCartPage2 NavigateToDefaultPage() // Metodas refresina puslapi pries kiekviena testa
        {
        ...
        public PiguCartPage2 LogInProcedure(string email, string password)
        {
            LoginIcon.Click();
        ...
        public PiguCartPage2 RemoveFromCartOperation()
        {
        ...
        public PiguCartPage2 EmptyCartConformation()
        {
        ...
        public PiguCartPage2 IfNotEmptyThanEmptyCartConformation()
        {
            bool ifas = false;
            try
            {
        ...
        public PiguCartPage2 CartContinueNewPersonTakeOrder(string Name, string surname)
        {
        ...
        public PiguCartPage2 LogOutProcedure()
        {
        ...
        public PiguCartPage2 NewReceivercheckUp(string Name, string surname)
        {
