...
{
    public class PiguPage2 : BasePage2
    {
        ...
        public PiguPage2(IWebDriver webdriver) : base(webdriver)//konstruktoriumi perduodame driver is base klases
        {
            //driver = webdriver;

        }
        public PiguPage2 NavigateToDefaultPage() // Metodas refresina puslapi pries kiekviena testa
        {
        ...
        [Obsolete]
        public PiguPage2 LogInProcedure(string email, string password)
        {
            LoginIcon.Click();
        ...
        public PiguPage2 RegistrationProcedure(string password)
        {
        ...
        public PiguPage2 RegistrationVerification(string email)
        {
        ...
        public PiguPage2 VerificationOfLogedUser(string email)
        {
        ...
        public PiguPage2 InputInItemEnterField(string item)
        {
        ...
        public PiguPage2 SearchForItemNavigationCliks()
        {
        ...
        public PiguPage2 LogOutProcedure()
        {
            Actions action = new Actions(driver);
        ...
        public PiguPage2 LogOutVerification()
        {
        ...
        public PiguPage2 SelectrForomWarrantyDropdownList()
        {
            warrantyDropdownList.SelectByValue("5fe196d2ed8680bd085e70ad2d03d0af");
            return this;

        }
        public PiguPage2 ItemInCartValidation()
        {
            PiguCart.Click();
